...
description: Route IMA project, lifecycle, preferences, and durable knowledge through Pi, Serena, Vestige, and Qdrant.
---
...
persistence and corpus receipt/direct-reassembly verification. Pi's global `AGENTS.md` owns
routine current preferences; Vestige remains a bounded cited-legacy and migration source, never a
routine preference bootstrap or lifecycle fallback. Use this skill to select the right memory system
and evidence order; do not duplicate tool-owned setup or persistence procedures.
