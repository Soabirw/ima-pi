...
const CYCLE_STATE_KEYS = ["schemaVersion", "source", "lifecycleKey", "implementationMode", "mode", "phase", "status", "reviewAttempts", "reviewCap", "evidence", "blockers", "updatedAt", "stoppedAt", "stoppedPhase", "trackerClosed", "branchId", "execution"] as const;
