...
- Fixed manual closeout to partition exact lifecycle evidence by phase, separately recall decision and conditional prior-closeout evidence, treat each phase's 20-descriptor result as saturation, and preserve unchanged descriptor-to-get verification.
