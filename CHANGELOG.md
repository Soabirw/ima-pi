...
- Enforced P/R/S lineage authority: P is the verified provider-pin anchor, R the original plan root, and S the stable source identity. Rootless original plans remain valid; later records and rooted initial pins retain the original lineage, while approval receipts preserve original R/S without replacing the root. Legacy rootless non-plan pins remain unchanged but block with no repair, migration, repinning, or fallback; future non-plan rootless first writes reject before effects, and closeout revalidates exact P/R/S before any tracker effect.
