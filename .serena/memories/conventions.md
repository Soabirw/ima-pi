...
- For task work, recall formal lifecycle artifacts through exact Tier-1 Qdrant manifest lookup plus selected direct detail fetch; routine cross-project preferences resolve through Pi global AGENTS.md, and Vestige is retained only for cited legacy evidence and T7 migration—not a lifecycle fallback.
