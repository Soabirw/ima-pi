...
- `ima_context` uses package-owned direct MCP sessions for Serena and cited Vestige preference sources; formal lifecycle hydration, `ima_lifecycle`, and `/ima:cycle` reconciliation use the package-native Tier-1 Qdrant corpus with manifest summary recall and verified direct detail reassembly.