...
- `ima_context` uses package-owned direct MCP sessions for Serena, Vestige, and optional Qdrant work; Jira and Taskwarrior retain their native boundaries, while `/ima:cycle` reconciliation uses direct Vestige `recall` through the package MCP adapter.