...
This entire session is planning-only. Use `ima_context` and Serena-first evidence before broad discovery, then perform targeted symbol and repository research plus correlated Vestige/durable evidence. Ask only unresolved architecture, rollout, security, or verification questions.
